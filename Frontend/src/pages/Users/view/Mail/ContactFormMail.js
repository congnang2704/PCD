    ...
    <div className="form-wrapper">
      <div className="form-background-overlay">
        ...
        <Row gutter={32} className="form-container">
          ...
          <Col xs={24} md={12} className="form-contact">
            <Form form={form} layout="vertical" onFinish={onFinish}>
              ...
              <div style={{ marginBottom: 16, textAlign: "center" }}>
                <Turnstile
                  key={turnstileResetKey} // ✅ ép reset widget khi cần
                  sitekey={TURNSTILE_SITE_KEY}
                  onVerify={(token) => setCfToken(token)}
                  onExpire={() => setCfToken("")}
                  onError={() => {
                    setCfToken("");
                    // giúp bạn debug rõ khi widget lỗi / bị chặn script
                    console.warn(
                      "Turnstile error: widget failed to load/verify."
                    );
                  }}
                  options={{
                    theme: "light",
          ...
          {screens.md && (
            <Col xs={24} md={12} className="form-side">
