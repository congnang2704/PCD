...
// Map URL (để const ngoài component cho nhẹ re-render)
...
const Container_Contacts = () => {
  ...
  // chuyển ngân sách sang value để bắn GA
    ...
    async (values) => {
      ...
      try {
        ...
        window.dataLayer.push({
          ...
          form_name: "Container_Contacts_Form",
          budget: values.budget,
          location: values.location,
        });
  ...
  return (
    <div className="contact-us-container">
      ...
      {/* ✅ Lazy Map: chỉ load khi scroll gần tới hoặc click */}
...
export default React.memo(Container_Contacts);
