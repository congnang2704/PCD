      ...
      <div className="finishing-wrapper">
        ...
        <div className="finishing-header">
          <h1 className="finishing-title">
            GIỚI THIỆU CÔNG TY TNHH MTV <br />
            <span className="highlight-blue">
              PCD NGUYỄN HẢI - THI CÔNG TRỌN GÓI - THI CÔNG HOÀN THIỆN
            </span>
          </h1>
        </div>
        ...
        <div className="finishing-image-container">
          <img
            src={finishing1}
            alt="Công trình hoàn thiện do PCD Nguyễn Hải thực hiện"
            className="finishing-image"
            loading="lazy"
          />
          <div className="finishing-caption">
            <em>Công trình hoàn thiện do PCD Nguyễn Hải thực hiện</em>
          </div>
        </div>
