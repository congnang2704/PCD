...
const Container_Villa = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      // 1) Show cache ngay (perceived instant)
      const cacheKey = `villa:${CATEGORY_NAME}`;
      ...
      try {
        const q = buildQuery({
          ...
          limit: 400, // đủ rộng để lọc theo 1 danh mục
          fields:
  ...
  return (
    <div className="house-container">
      <h2 className="house-title">MẪU BIỆT THỰ ĐẸP, SANG TRỌNG</h2>
      <p className="house-subtitle">
        Tinh tế trong từng đường nét, không gian sống đỉnh cao.
      </p>
...
export default Container_Villa;
