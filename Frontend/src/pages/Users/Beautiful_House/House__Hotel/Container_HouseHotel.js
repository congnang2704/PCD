...
const Container_ApartmentHotel = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const cacheKey = `apart-hotel:${CATEGORY_NAME}`;
  ...
  return (
    <div className="house-container">
      <h2 className="house-title">MẪU CĂN HỘ - KHÁCH SẠN ĐẸP</h2>
      <p className="house-subtitle">
        Thiết kế tối ưu công năng lưu trú, thẩm mỹ hiện đại.
      </p>
...
export default Container_ApartmentHotel;
